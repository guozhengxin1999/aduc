...
# ----- fire department -----
@app.post("/fireDepartment")
async def fire_department():
    return Response(status_code=200)

# ----- hospital department -----
@app.post("/hospitalDepartment")
async def hospital_department():
    return Response(status_code=200)
...
@app.post("/vToVCommunication")
async def vtov_communication():
    return Response(status_code=200)
